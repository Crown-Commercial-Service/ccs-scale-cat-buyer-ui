...
export default function (app: Application): void {
    ...
    app.get(PROCUREMENT_PATHS.ROUTE_TO_MARKET, [AUTH], associatedViews.ROUTE_TO_MARKET)

    app.get(PROCUREMENT_PATHS.CHOOSE_ROUTE, [
        ContentFetchMiddleware.FetchContents,
        AUTH, AgreementDetailsFetchMiddleware.FetchAgreements], associatedViews.GET_CHOOSE_ROUTE)

    app.post(PROCUREMENT_PATHS.POST_CHOOSE_ROUTE, AUTH, associatedViews.POST_CHOOSE_ROUTE )
}
