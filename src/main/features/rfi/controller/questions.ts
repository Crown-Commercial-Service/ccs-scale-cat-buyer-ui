...
// path = '/rfi/questionnaire'
               ...
               for(let iteration of sortedStorage){
                  let answerBody = {
                   ...
                   try {
                     ...
                     POST_UPDATINGDATA(proc_id, event_id, SESSION_ID, group_id, agreement_id, id, res)
                   } catch (error) {
                      res.redirect('/404')
                   }
               }
 ...
 const POST_UPDATINGDATA = async (proc_id : any, event_id: any, SESSION_ID: string, group_id: any, agreement_id: any, id: any, res: express.Response) => {
      /**
             * @Path
             * @Next
