...
export const RESPONSEDATEHELPER = async (req: express.Request, res: express.Response, errorTriggered, errorItem) => {
    ...
    try {
        ...
        const rfi_clarification_period_end = moment(clarification_period_end_date_parsed, 'DD-MM-YYYY').businessAdd(predefinedDays.clarification_days)._d
        ...
        let appendData = {
            ...
            rfi_clarification_period_end: moment(rfi_clarification_period_end, 'DD/MM/YYYY, hh:mm a').format('DD MMMM YYYY, hh:mm a'),
