...
export const RFP_GET_SERVICE_CAPABILITIES = async (req: express.Request, res: express.Response) => {
  ...
  try {
   ...
   // 
    ...
    const windowAppendData = { ...RFPService, lotId, agreementLotName, releatedContent, isError, errorText, TABLE_HEADING:TableHeadings, TABLE_BODY: TABLEBODY, WHOLECLUSTER: WHOLECLUSTERCELLS };
