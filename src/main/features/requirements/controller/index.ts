...
import {
  ...
  RFP_POST_DELETE_COLLABORATOR_TO_JAGGER,
...
import { RFP_SUPPLIER_RATECARD } from './rfp-supplierRateCard';
import {
  ...
  CA_POST_DELETE_COLLABORATOR_TO_JAGGER,
...
import { RFP_GET_UPLOAD_ADDITIONAL , RFP_POST_UPLOAD_ADDITIONAL,RFP_POST_UPLOAD_ADDITIONAL_PROCEED } from './rfp-uploadAdditional';
import { RFP_GET_UPLOAD_ADDITIONAL_DOC , RFP_POST_UPLOAD_ADDITIONAL_DOC,RFP_POST_UPLOAD_ADDITIONAL_DOC_PROCEED } from './rfp-uploadAdditionalDoc';
...
export const REQUIREMENT_CONTROLLER = {
  ...
  RFP_GET_ADDITIONAL_SERVICES,
  RFP_GET_CONFIRMATION_REVIEW,
  PUBLISH_DATE_MISMATCH,
  PUBLISH_DATE_MISMATCH_CANCEL,
  RFP_GET_SELECTED_SERVICE,
  RFP_POST_SELECTED_SERVICE,
  RFP_POST_ADDITIONAL_SELECT_SERVICES,
  ...
  //DOS6
  DOS6_STAGE2_TASK_LIST,

  RFP_SUPPLIER_RATECARD,
};
