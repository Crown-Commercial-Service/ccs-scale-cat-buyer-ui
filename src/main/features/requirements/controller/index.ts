...
import { DA_GET_ADD_COLLABORATOR,DA_POST_ADD_COLLABORATOR,DA_POST_ADD_COLLABORATOR_JSENABLED,DA_POST_ADD_COLLABORATOR_TO_JAGGER,DA_POST_PROCEED_COLLABORATORS } from './da-addcollaborator';
/**
 * @BaseController
 * @Provider
 *
