 ...
 * @GETController
 */
export const DA_GET_LEARN_START = async (req: express.Request, res: express.Response) => {
...
export const DA_POST_LEARN_START = async (req: express.Request, res: express.Response) => {
  const { SESSION_ID } = req.cookies;
