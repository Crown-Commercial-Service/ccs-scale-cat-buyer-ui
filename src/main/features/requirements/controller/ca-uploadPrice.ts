...
import * as cmsData from '../../../resources/content/requirements/caUploadPrice.json';
import { TokenDecoder } from '../../../common/tokendecoder/tokendecoder';
import { LoggTracer } from '../../../common/logtracer/tracer';
import config from 'config';

// FC cancel
export const CA_GET_UPLOAD_PRICING = async (req: express.Request, res: express.Response) => {
...
export const CA_POST_UPLOAD_PRICING = async (req: express.Request, res: express.Response) => {
  const { SESSION_ID } = req.cookies;
  const { projectId } = req.session;
