  ...
  try {
    ...
    fetchQuestionsData.forEach((el) => {
      if(el.OCDS.id == 'Question 7') {
            ...
            dataManipulation.time_line = {"title":"Do you want supplier presentations?","description":"Selecting ‘Yes’ will add a 5-day presentation period to your timeline","conditional":{"dependentOnID":"Question 7","dependencyType":"EqualTo","dependencyValue":"Yes"},"options":[{"value":"Yes","text":"","select":true},{"value":"No","text":"","select":false}],"answered":false};
        }
