...
export default function (app: Application): void {
  ...
  app.get(REQUIREMENT_PATHS.DA_GET_USER_PROCUREMENT, [AUTH], REQUIREMENT_CONTROLLER.DA_GET_USER_PROCUREMENT);
   ...
   */
   app.get(
    REQUIREMENT_PATHS.DA_GET_NAME_PROJECT,
    [AUTH, AgreementDetailsFetchMiddleware.FetchAgreements],
   ...
   */
    app.get(
      REQUIREMENT_PATHS.DA_GET_LEAD_PROCUREMENT,
      [AUTH, AgreementDetailsFetchMiddleware.FetchAgreements],
   ...
   */
      app.get(
        REQUIREMENT_PATHS.DA_GET_ADD_COLLABORATOR,
        [AUTH, AgreementDetailsFetchMiddleware.FetchAgreements],
 ...
 app.post(REQUIREMENT_PATHS.DA_POST_NAME_PROJECT, AUTH, REQUIREMENT_CONTROLLER.DA_POST_NAME_PROJECT);
  ...
  app.post(REQUIREMENT_PATHS.DA_POST_ADD_COLLABORATOR, AUTH, REQUIREMENT_CONTROLLER.DA_POST_ADD_COLLABORATOR);
  ...
  app.post(REQUIREMENT_PATHS.DA_PUT_LEAD_PROCUREMENT, AUTH, REQUIREMENT_CONTROLLER.DA_PUT_LEAD_PROCUREMENT);
  ...
  app.post(REQUIREMENT_PATHS.DA_POST_PROCEED_COLLABORATORS, AUTH, REQUIREMENT_CONTROLLER.DA_POST_PROCEED_COLLABORATORS);
  ...
  app.get(REQUIREMENT_PATHS.CA_POST_DELETE_COLLABORATOR_TO_JAGGER,AUTH,REQUIREMENT_CONTROLLER.CA_POST_DELETE_COLLABORATOR_TO_JAGGER,);

  app.get(REQUIREMENT_PATHS.DA_POST_DELETE_COLLABORATOR_TO_JAGGER,AUTH,REQUIREMENT_CONTROLLER.DA_POST_DELETE_COLLABORATOR_TO_JAGGER,);
  ...
  app.post(
    REQUIREMENT_PATHS.DA_POST_ADD_COLLABORATOR_TO_JAGGER,AUTH,
  ...
  app.post(REQUIREMENT_PATHS.RFP_POST_UPLOAD_ADDITIONAL_DOC,AUTH,REQUIREMENT_CONTROLLER.RFP_POST_UPLOAD_ADDITIONAL_DOC);

  app.post(REQUIREMENT_PATHS.RFP_POST_UPLOAD_ADDITIONAL_DOC_PROCEED,AUTH,REQUIREMENT_CONTROLLER.RFP_POST_UPLOAD_ADDITIONAL_DOC_PROCEED );
  
  app.get(REQUIREMENT_PATHS.RFP_GET_REMOVE_ADDITIONAL_DOC_FILES,AUTH,REQUIREMENT_CONTROLLER.RFP_GET_REMOVE_ADDITIONAL_DOC_FILES );
