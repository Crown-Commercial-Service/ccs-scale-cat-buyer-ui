...
export default function (app: Application): void {
 ...
 app.post(REQUIREMENT_PATHS.DA_POST_NAME_PROJECT_REQUIRE, AUTH, REQUIREMENT_CONTROLLER.DA_POST_NAME_PROJECT);
  ...
  app.post(REQUIREMENT_PATHS.DA_POST_PROCEED_COLLABORATORS_REQUIRE, AUTH, REQUIREMENT_CONTROLLER.DA_POST_PROCEED_COLLABORATORS);
  ...
  app.get(REQUIREMENT_PATHS.DA_POST_DELETE_COLLABORATOR_TO_JAGGER_REQUIRE,AUTH,REQUIREMENT_CONTROLLER.DA_POST_DELETE_COLLABORATOR_TO_JAGGER,);
  ...
  app.post(
    REQUIREMENT_PATHS.DA_POST_ADD_COLLABORATOR_TO_JAGGER_REQUIRE,AUTH,
