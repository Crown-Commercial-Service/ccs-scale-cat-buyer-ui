...
export default function (app: Application): void {
  ...
  app.get(DIGITALOUTCOMES_PATHS.OPPORTUNITIES_DOWNLOAD, DIGITALOUTCOMES_CONTROLLER.OPPORTUNITIES_DOWNLOAD);
  app.get(DIGITALOUTCOMES_PATHS.OPPORTUNITY_DETAILS_DOWNLOAD, DIGITALOUTCOMES_CONTROLLER.OPPORTUNITY_DETAILS_DOWNLOAD);
}
