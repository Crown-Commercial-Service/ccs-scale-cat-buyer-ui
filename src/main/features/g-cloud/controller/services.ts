...
export const GET_SERVICES = async (req: express.Request, res: express.Response) => {
    ...
    try {
        let baseURL: string = `services/${id}`; 
        var {data: serviceData} = await gCloudApi.serviceInstance(GCLOUD_TOKEN).get(baseURL);
        let supplierbaseURL: string = `suppliers/${serviceData.services.supplierId}`; 
        var {data: supplierData} = await gCloudApi.serviceInstance(GCLOUD_TOKEN).get(supplierbaseURL);
        let supplierSlaveryDocumentURL: string = `suppliers/${serviceData.services.supplierId}/frameworks/g-cloud-13`; 
        var {data: supplierSlaveryDocumentData} = await gCloudApi.serviceInstance(GCLOUD_TOKEN).get(supplierSlaveryDocumentURL);
        var supplierDetails = {} as SupplierModel;
        ...
        supplierDetails.modernSlaveryStatementEXTENTION=(supplierSlaveryDocumentData.frameworkInterest.declaration.modernSlaveryStatement !==null && supplierSlaveryDocumentData.frameworkInterest.declaration.modernSlaveryStatement !==undefined)?path.extname(supplierSlaveryDocumentData.frameworkInterest.declaration.modernSlaveryStatement).replace('.', ''):'';
        ...
        supplierDetails.modernSlaveryStatementOptionEXTENTION=(supplierSlaveryDocumentData.frameworkInterest.declaration.modernSlaveryStatementOptional !==null && supplierSlaveryDocumentData.frameworkInterest.declaration.modernSlaveryStatementOptional !==undefined)?path.extname(supplierSlaveryDocumentData.frameworkInterest.declaration.modernSlaveryStatementOptional).replace('.', ''):'';


        }
        var serviceDetails = {} as ServiceModel;
        if (serviceData != null) {
          ...
          serviceDetails.webChatSupportAccessibilityDescription=serviceData.services.webChatSupportAccessibilityDescription;
          ...
          serviceDetails.informationSecurityPoliciesAndProcesses=serviceData.services.informationSecurityPoliciesAndProcesses;
          serviceDetails.configurationAndChangeManagementType=serviceData.services.configurationAndChangeManagementType;
          serviceDetails.configurationAndChangeManagementProcesses=serviceData.services.configurationAndChangeManagementProcesses;
          ...
          serviceDetails.priceUnit=(serviceData.services.priceUnit !==null && serviceData.services.priceUnit !==undefined)?await priceContent(serviceData.services.priceUnit):'';
          serviceDetails.priceInterval=(serviceData.services.priceInterval !==null && serviceData.services.priceInterval !==undefined)?await priceContent(serviceData.services.priceInterval):'';
          ...
          serviceDetails.pricingDocumentEXTENTION=(serviceData.services.pricingDocumentURL !==null && serviceData.services.pricingDocumentURL !==undefined)?path.extname(serviceData.services.pricingDocumentURL).replace('.', ''):'';

          serviceDetails.sfiaRateDocumentEXTENTION=(serviceData.services.sfiaRateDocumentURL !==null && serviceData.services.sfiaRateDocumentURL !==undefined)?path.extname(serviceData.services.sfiaRateDocumentURL).replace('.', ''):'';

          serviceDetails.serviceDefinitionDocumentEXTENTION=(serviceData.services.serviceDefinitionDocumentURL !==null && serviceData.services.serviceDefinitionDocumentURL !==undefined)?path.extname(serviceData.services.serviceDefinitionDocumentURL).replace('.', ''):'';
          serviceDetails.termsAndConditionsDocumentEXTENTION=(serviceData.services.termsAndConditionsDocumentURL !==null && serviceData.services.termsAndConditionsDocumentURL !==undefined)?path.extname(serviceData.services.termsAndConditionsDocumentURL).replace('.', ''):'';
          ...
          serviceDetails.installationCompatibleOperatingSystems=serviceData.services.installationCompatibleOperatingSystems;
          ...
          serviceDetails.serviceInterfaceAccessibilityDescription=serviceData.services.serviceInterfaceAccessibilityDescription;
