...
export default function(app: Application): void {
 ...
 app.get(GCloud_PATHS.GET_HOME_GCloud, [NO_AUTH], associatedViews_GCloud.GET_SEARCH_HOME_GCLOUD)
 app.get(GCloud_PATHS.GET_SERVICEES_RESULT_GCLOUD, [NO_AUTH], associatedViews_GCloud.GET_SERVICE_RESULT_GCLOUD)
}
