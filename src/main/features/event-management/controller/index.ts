import { EVENT_MANAGEMENT_CLOSE,EVENT_MANAGEMENT,CONFIRM_SUPPLIER_AWARD,RETURN_EVENTMANAGEMENT,EVENT_STATE_CHANGE } from './eventManagement'
...
import { EVENT_MANAGEMENT_MESSAGING_CREATE, POST_MESSAGING_CREATE,EVENT_MANAGEMENT_MESSAGING_SUBBLIER_CREATE,POST_MESSAGING_SUBBLIER_CREATE } from './MessagingCreate'
import { EVENT_MANAGEMENT_MESSAGING_SENT } from './MessagingSent'
import { EVENT_MANAGEMENT_QA,EVENT_MANAGEMENT_SUPPLIER_QA,EVENT_MANAGEMENT_QA_POPUP, EVENT_MANAGEMENT_QA_SUPPLIERS  } from './viewQA'
...
import { EVENT_MANAGEMENT_DOWNLOAD, START_EVALUATION, START_EVALUATION_REDIRECT } from './eventManagement'
...
import { PUBLISHED_PROJECT_DOWNLOAD,SUPPLIER_ANSWER_DOWNLOAD,SUPPLIER_ANSWER_DOWNLOAD_ALL,SUPPLIER_EVALUATION,UNSUCCESSFUL_SUPPLIER_DOWNLOAD,INVITE_SUPPLIERS,INVITE_SELECTED_SUPPLIERS,SAVE_INVITE_SELECTED_SUPPLIERS } from './eventManagement'
import { GET_CONFIRM_SUPPLIER,POST_CONFIRM_SUPPLIER,Download_SUPPLIER_RESPONCE } from './confirmSupplier'
import { CLOSE_PROJECT } from './closeProject'
...
export const EVENT_MANAGEMENT_CONTROLLER = {
    ...
    EVENT_MANAGEMENT_MESSAGING_SUBBLIER_CREATE,
    POST_MESSAGING_SUBBLIER_CREATE,
    EVENT_MANAGEMENT_QA,
    EVENT_MANAGEMENT_QA_SUPPLIERS,
    EVENT_MANAGEMENT_QA_POPUP,
    EVENT_MANAGEMENT_SUPPLIER_QA,
    ...
    RETURN_EVENTMANAGEMENT,
    EVENT_STATE_CHANGE,
    INVITE_SUPPLIERS,
    INVITE_SELECTED_SUPPLIERS,
