...
export default function (app: Application): void {
 ...
 ///event/qa-edit
  ...
  //CONFIRM SUPPLIER PAGE
  app.get(
    EVENT_MANAGEMENT_PATHS.GET_CONFIRM_SUPPLIER,
    AUTH,
    EVENT_MANAGEMENT_CONTROLLER.GET_CONFIRM_SUPPLIER,
  );

  app.post(
    EVENT_MANAGEMENT_PATHS.POST_CONFIRM_SUPPLIER,
    AUTH,
    EVENT_MANAGEMENT_CONTROLLER.POST_CONFIRM_SUPPLIER,
  );
}