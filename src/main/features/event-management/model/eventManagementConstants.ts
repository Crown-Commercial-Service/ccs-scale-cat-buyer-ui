export enum EVENT_MANAGEMENT_PATHS {
    ...
    EVENT_MANAGEMENT_CLOSE = '/event/management_close',
    ...
    EVENT_MANAGEMENT_MESSAGING_SUBBLIER_CREATE = '/message/create/supplier',
    POST_MESSAGING_SUBBLIER_CREATE = '/message/createSupplier',
