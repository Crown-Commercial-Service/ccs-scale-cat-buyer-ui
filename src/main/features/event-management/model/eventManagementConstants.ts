export enum EVENT_MANAGEMENT_PATHS {
    ...
    EVENT_MANAGEMENT_SUPPLIER_QA = '/event/qa-supplier',
    EVENT_MANAGEMENT_SUPPLIER_DATA_QA = '/event/qa_data-supplier',
    ...
    EVENT_MANAGEMENT_MESSAGE_REPLY_TO_ALL='/message/replytoall',
    POST_EVENT_MANAGEMENT_MESSAGE_REPLY_TO_ALL='/message/replytoall',
