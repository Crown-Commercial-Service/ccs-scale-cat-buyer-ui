...
export default function (app: Application): void {
   ...
   // app.get(REQUIRMENT_DA_PATHS.DA_REQUIREMENT_TASK_LIST, [AUTH], REQUIREMENT_CONTROLLER.DA_REQUIREMENT_TASK_LIST);
    ...
    app.get(REQUIRMENT_DA_PATHS.DA_GET_REMOVE_FILES_ATTACHMENT, AUTH, REQUIREMENT_CONTROLLER.DA_GET_REMOVE_FILES_ATTACHMENT);
    ...
    app.post(REQUIRMENT_DA_PATHS.DA_POST_UPLOAD_ADDITIONAL_PROCEED,AUTH,REQUIREMENT_CONTROLLER.DA_POST_UPLOAD_ADDITIONAL_PROCEED );
  ...
  app.get(REQUIRMENT_DA_PATHS.DA_GET_ADD_COLLABORATOR,[AUTH, AgreementDetailsFetchMiddleware.FetchAgreements],REQUIREMENT_CONTROLLER.DA_GET_ADD_COLLABORATOR,);
    app.get(REQUIRMENT_DA_PATHS.DA_GET_SELECTED_SERVICE,[AUTH, AgreementDetailsFetchMiddleware.FetchAgreements],REQUIREMENT_CONTROLLER.DA_GET_SELECTED_SERVICE,);
  ...
  app.post(
    REQUIRMENT_DA_PATHS.DA_POST_ADD_COLLABORATOR_TO_JAGGER,AUTH,
    REQUIREMENT_CONTROLLER.DA_POST_ADD_COLLABORATOR_TO_JAGGER,
  );

   //@POST '/da/proceed-collaborators'
   app.post(REQUIRMENT_DA_PATHS.DA_POST_PROCEED_COLLABORATORS, AUTH, REQUIREMENT_CONTROLLER.DA_POST_PROCEED_COLLABORATORS);
   app.get(REQUIRMENT_DA_PATHS.DA_POST_DELETE_COLLABORATOR_TO_JAGGER,AUTH,REQUIREMENT_CONTROLLER.DA_POST_DELETE_COLLABORATOR_TO_JAGGER,);

   // /da/add-context
  app.get(REQUIRMENT_DA_PATHS.DA_ADD_CONTEXT,[AUTH, AgreementDetailsFetchMiddleware.FetchAgreements],REQUIREMENT_CONTROLLER.DA_ADD_CONTEXT,);

  // @GET "/da/suppliers"
  app.get(REQUIRMENT_DA_PATHS.GET_DA_SUPPLIERS,[AUTH, AgreementDetailsFetchMiddleware.FetchAgreements],REQUIREMENT_CONTROLLER.GET_DA_SUPPLIERS,);

  // @GET "/da/suppliers/ratecard"
  app.get(REQUIRMENT_DA_PATHS.SUPPLIER_DA_RATECARD,[AUTH, AgreementDetailsFetchMiddleware.FetchAgreements],REQUIREMENT_CONTROLLER.SUPPLIER_DA_RATECARD,);

  // @POST "da/suppliers"
  app.post(REQUIRMENT_DA_PATHS.POST_DA_SUPPLIER, AUTH, REQUIREMENT_CONTROLLER.POST_DA_SUPPLIER);

  app.get(REQUIRMENT_DA_PATHS.DA_GET_EVENT_PUBLISHED,[AUTH, AgreementDetailsFetchMiddleware.FetchAgreements],REQUIREMENT_CONTROLLER.DA_GET_EVENT_PUBLISHED,
  );
