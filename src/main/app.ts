...
app.use((req, res, next) => {
  ...
  res.setHeader(
    'Content-Security-Policy',
    "script-src 'self' 'unsafe-inline' *.googletagmanager.com  https://www.google-analytics.com https://ssl.google-analytics.com https://cdn2.gbqofs.com https://report.crown-comm.gbqofs.com; img-src 'self' *.google-analytics.com *.googletagmanager.com; connect-src 'self' *.google-analytics.com *.analytics.google.com *.googletagmanager.com https://report.crown-comm.gbqofs.io"
  );
