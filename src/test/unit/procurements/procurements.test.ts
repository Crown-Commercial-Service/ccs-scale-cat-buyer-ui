...
import  data from '../../data/procurements.json';
chais.should();
chais.use(chaiHttp);

describe('Procurement overview: Procurement overview', async () => {
  let parentApp;
  let OauthToken;
  ...
  it('should render `Procurement overview ` page when everything is fine', async () => {
